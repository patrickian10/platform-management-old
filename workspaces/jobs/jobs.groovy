...
if [[ "${PROJECT_NAME}" =~ ${pattern} ]]; then
	...
	exit 1
        ...
        shell('''set -e
# LDAP
chmod 775 ${WORKSPACE}/common/ldap/generate_role.sh 
chmod -R +x  ${WORKSPACE}/common/ldap/lib/*
chmod 775 ${WORKSPACE}/common/ldap/load_ldif.sh
chmod +x ${WORKSPACE}/common/gerrit/create_user.sh
